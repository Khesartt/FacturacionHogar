...
{
    public class SampleOfServiceRepository : DefaultEntityFrameworkRepository<SampleOfService>, ISampleOfServiceRepository
    {
        public SampleOfServiceRepository(ApiContext context) : base(context)
        {
        }
    }
}
